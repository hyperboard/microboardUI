  ...
  editButton.onclick = async () => {
    ...
    try {
      ...
      const { initInter } = await import(
        "https://www.unpkg.com/microboard-ui-temp@0.0.36/dist/index.js"
      );
      initInter();
      ...
      const response = await fetch(
        "https://www.unpkg.com/microboard-ui-temp@0.0.36/dist/index.css",
      );
      ...
      const responseSvg = await fetch(
        "https://www.unpkg.com/microboard-ui-temp@0.0.36/dist/sprite.svg",
      );
