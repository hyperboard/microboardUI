...
document.addEventListener("DOMContentLoaded", () => {
  ...
  editButton.onclick = async () => {
    ...
    try {
      ...
      const { initInter } = await import(
        "https://www.unpkg.com/microboard-ui-temp@0.0.38/dist/index.js"
      );
      initInter();
      ...
      const response = await fetch(
        "https://www.unpkg.com/microboard-ui-temp@0.0.38/dist/index.css",
      );
      ...
      const responseSvg = await fetch(
        "https://www.unpkg.com/microboard-ui-temp@0.0.38/dist/sprite.svg",
      );
  ...
  const handleShareBoard = async (ev) => {
    ...
    const { boardsApi, createApp, frontConf } = await import(
      "https://www.unpkg.com/microboard-ui-temp@0.0.38/dist/index.js"
    );
