See [slate docs](https://github.com/ianstormtaylor/slate/tree/main/docs).

# Editor API [from](https://raw.githubusercontent.com/ianstormtaylor/slate/main/docs/api/nodes/editor.md)
