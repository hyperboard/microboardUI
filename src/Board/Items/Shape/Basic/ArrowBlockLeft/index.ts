...
export const ArrowBlockLeft = {
	...
	path: new Path(
		[
			new Line(new Point(0, 50), new Point(20, 0)),
			new Line(new Point(20, 0), new Point(100, 0)),
			new Line(new Point(100, 0), new Point(80, 50)),
			new Line(new Point(80, 50), new Point(100, 100)),
