...
describe("transformRichTextOperation", () => {
	...
	describe("Complex Operation Path Transformation", () => {
		it("should correctly transform remove_text operations with different paths", () => {
			const confirmed: RichTextOperation = {
				class: "RichText",
				method: "edit",
				item: ["0d90727d-0ea8-43bf-94e0-79517127b814"],
				selection: {
