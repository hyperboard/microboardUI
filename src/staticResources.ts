export const CUSTOM_WEB_COMPONENTS_JS = `/* eslint-disable max-classes-per-file, @typescript-eslint/no-useless-constructor */
...
export const LOAD_LINKS_IMAGES_JS = `document.addEventListener("DOMContentLoaded", function () {
...
export const INDEX_CSS = `@import "https://fonts.googleapis.com/css2?family=Manrope:wght@200..800&display=swap";
