...
class WhiteboardApp {
    ...
    private itemRegistry = new Map<string, { factory: () => Command, validator?: (data: any) => boolean }>();
     ...
     */
    registerComponent(componentName: string, component: any, decorator?: (baseComponent: any) => any): void {
        const existingComponent = this.componentRegistry.get(componentName);
        this.componentRegistry.set(componentName, decorator ? decorator(existingComponent) : component);
    }
    ...
    */
    registerItem(itemId: string, factory: () => Command, dataValidator?: (data: any) => boolean): void {
...
function registerPlugin(plugin: WhiteboardPlugin, whiteboardApp: WhiteboardApp): void {
