export const Icons = {
	...
	AddFrame: {
		paths: ["M5.375 1V29M24.3335 1V15V29M29 22.875H1M29 7.125H14.125H1"],
		width: 28,
		heigth: 28,
	},
	Custom: {
	...
	shareLink: {
		paths: [
			"M14.7222 12.0209C14.7222 12.0209 12.6389 11.9739 10.5556 12.021C7.77778 11.9739 5 14.1044 5 17.5765C5 21.0487 7.77778 23.0693 10.5556 23.132C12.6389 23.1791 14.7222 23.132 14.7222 23.132",
			"M20.2778 23.1532C20.2778 23.1532 22.3611 23.2001 24.4444 23.1531C27.2222 23.2001 30 21.0697 30 17.5975C30 14.1253 27.2222 12.1047 24.4444 12.042C22.3611 11.9949 20.2778 12.042 20.2778 12.042",
			"M12 16.6704H23V18.6704H12V16.6704Z",
		],
		width: 36,
		height: 36,
	},
	saveAsImage: {
		paths: [
			"M33 12V8C33 6.89543 32.1046 6 31 6L27 6",
			"M3 12L3 8C3 6.89543 3.89543 6 5 6L9 6",
			"M3 23L3 27C3 28.1046 3.89543 29 5 29H9",
			"M33 23V27C33 28.1046 32.1046 29 31 29H27",
			"M11.5 22.5H24.5C25.6046 22.5 26.5 21.6046 26.5 20.5V14.5C26.5 13.3954 25.6046 12.5 24.5 12.5H11.5C10.3954 12.5 9.5 13.3954 9.5 14.5V20.5C9.5 21.6046 10.3954 22.5 11.5 22.5Z",
		],
		width: 36,
		heigth: 36,
	},
	...
	Tail: {
		paths: [
			"M13.9773 9.16591L9.50732 4.69591L10.6857 3.51758L17.1673 9.99924L10.6857 16.4809L9.50732 15.3026L13.9773 10.8326H3.83398V9.16591H13.9773Z",
		],
		width: 20,
		height: 20,
	},
